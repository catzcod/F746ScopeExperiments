...
/* Button connection*/
#define BTN1_GPIO_Port USER_Btn_GPIO_Port
#define BTN1_Pin  USER_Btn_Pin

#define BTN2_GPIO_Port USER_Btn_GPIO_Port
#define BTN2_Pin  USER_Btn_Pin

#define BTN3_GPIO_Port USER_Btn_GPIO_Port
#define BTN3_Pin  USER_Btn_Pin
...
void settingsBar()
{
    ...
    {
        setTextColor(BLACK, WHITE);
        drawFastHLine(0, (uint16_t)((PIXDIV * YDIV / 2 - 1) - (trigVoltage * PIXDIV / vdiv)), XDIV * PIXDIV, RED);
    }
    setCursor(30, 115);
...
void outputSerial(char s[], uint8_t o)
{
    ...
    case 1:
        ...
        break;
    case 2:
        HAL_UART_Transmit(&huart3, s, strlen(s), HAL_MAX_DELAY);
        break;
    default:
        break;
    }
